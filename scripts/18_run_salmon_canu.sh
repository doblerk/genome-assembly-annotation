...
#SBATCH --output=/data/users/kdobler/assembly_annotation_course/outputs/output_salmon_canu_%j.o
#SBATCH --error=/data/users/kdobler/assembly_annotation_course/outputs/error_salmon_canu_%j.e
...
OUTPUTDIR=${WORKDIR}/salmon_outputs/canu
...
salmon index \
 -t ${WORKDIR}/maker_outputs/canu/pilon.all.maker.transcripts.fasta \
 -i transcripts_index \
 -k 31
