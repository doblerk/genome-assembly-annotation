...
#SBATCH --output=/data/users/kdobler/assembly_annotation_course/outputs/output_dating_flye_%j.o
#SBATCH --error=/data/users/kdobler/assembly_annotation_course/outputs/error_dating_flye_%j.e
...
INPUTDIR=${WORKDIR}/edta_outputs/flye
OUTPUTDIR=${WORKDIR}/te_dating/flye
...
bedtools getfasta -fi ${WORKDIR}/polished_assemblies/flye/pilon.fasta -bed genome.mod.EDTA.intact.gff3_LTR_ref -name > genome.mod.EDTA.intact.LTR.fa
