...
#SBATCH --output=/data/users/kdobler/assembly_annotation_course/outputs/output_merqury_unpolished_%j.o
#SBATCH --error=/data/users/kdobler/assembly_annotation_course/outputs/error_merqury_unpolished_%j.e
...
cd ${WORKDIR}/evaluation_assemblies/merqury/flye_unpolished
...
cd ${WORKDIR}/evaluation_assemblies/merqury/canu_unpolished
...
merqury.sh \
${dir_output_meryl}/Illumina.meryl \
${WORKDIR}/assemblies/canu/canu_pacbio.contigs.fasta \
canu_unpolished
