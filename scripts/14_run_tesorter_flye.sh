...
OUTPUTDIR=${WORKDIR}/tesorter_outputs/flye
...
bedtools getfasta \
 -s \
 -name \
 -fi /data/users/kdobler/assembly_annotation_course/ASSEMBLY/polished_assemblies/flye/pilon.fasta \
...
${CONTAINER}/TEsorter_1.3.0.sif \
 TEsorter Ler_flye_TEs -db rexdb-plant
