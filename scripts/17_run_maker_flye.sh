...
#SBATCH --output=/data/users/kdobler/assembly_annotation_course/outputs/output_maker_flye_%j.o
#SBATCH --error=/data/users/kdobler/assembly_annotation_course/outputs/error_maker_flye_%j.e
...
OUTPUTDIR=${WORKDIR}/maker_outputs/flye
...
cd ${WORKDIR}/busco_anno_outputs/flye
busco \
 -i ${WORKDIR}/maker_outputs/flye/pilon.all.maker.proteins.fasta \
 -l brassicales_odb10 \
 -m proteins \
 -c 4 \
 --out busco_output
