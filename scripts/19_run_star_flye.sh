...
#SBATCH --output=/data/users/kdobler/assembly_annotation_course/outputs/output_star_flye_%j.o
#SBATCH --error=/data/users/kdobler/assembly_annotation_course/outputs/error_star_flye_%j.e
...
OUTPUTDIR=${WORKDIR}/star_outputs/flye
GFFDIR=${WORKDIR}/maker_outputs/flye/maker_functional.gff
DATADIR=${WORKDIR}/polished_assemblies/flye/pilon.fasta
